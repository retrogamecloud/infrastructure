...
# Secret para GitHub OAuth de Grafana
resource "kubernetes_secret" "grafana_github_oauth" {
  ...
  data = {
    ...
    GF_AUTH_GITHUB_CLIENT_ID             = local.grafana_oauth_client_id
    GF_AUTH_GITHUB_CLIENT_SECRET         = local.grafana_oauth_client_secret
    GF_AUTH_GITHUB_SCOPES                = "user:email,read:org"
    GF_AUTH_GITHUB_AUTH_URL              = "https://github.com/login/oauth/authorize"
    GF_AUTH_GITHUB_TOKEN_URL             = "https://github.com/login/oauth/access_token"
    GF_AUTH_GITHUB_API_URL               = "https://api.github.com/user"
    GF_AUTH_GITHUB_ALLOWED_ORGANIZATIONS = "retrogamecloud"
  }
  ...
  values = [
    yamlencode({
      ...
      grafana = {
        ...
        # Load GitHub OAuth configuration from secret
        envFromSecrets = [
          {
            name = "grafana-github-oauth"
          }
